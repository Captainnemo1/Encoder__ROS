...
static const _Rbl_type_support_symbol_names_t _Rbl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rbl_message, msg, Rbl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rbl_message, msg, Rbl)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rbl_message, msg, Rbl)() {
  return &::rbl_message::msg::rosidl_typesupport_c::Rbl_message_type_support_handle;
}
